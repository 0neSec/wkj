...
import { Factory, Leaf, Store } from "lucide-react";
...
import DaftarProdusenJamu from "../component/card/produsen";
      ...
      >
        <div className="flex items-center justify-center mb-8 relative">
          ...
          <motion.div
            ...
            className="bg-green-100 p-3 rounded-full shadow-md"
          >
            <Factory className="text-green-800 w-6 h-6" />
          </motion.div>
        ...
        <motion.div
          ...
          className="mt-8"
        >
          <DaftarProdusenJamu isHomePage={true}/>
        </motion.div>
      </motion.div>
